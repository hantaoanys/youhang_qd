<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="未提现的邀请人数" prop="inviteNumberNotMoney">
        <el-input
          v-model="queryParams.inviteNumberNotMoney"
          placeholder="请输入未提现的邀请人数"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="已提现的邀请人数" prop="inviteNumberMoney">
        <el-input
          v-model="queryParams.inviteNumberMoney"
          placeholder="请输入已提现的邀请人数"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="inviteList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="未提现的邀请人数" align="center" prop="inviteNumberNotMoney" />
      <el-table-column label="已提现的邀请人数" align="center" prop="inviteNumberMoney" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="未提现的邀请人数" prop="inviteNumberNotMoney">
          <el-input v-model="form.inviteNumberNotMoney" placeholder="请输入未提现的邀请人数" />
        </el-form-item>
        <el-form-item label="已提现的邀请人数" prop="inviteNumberMoney">
          <el-input v-model="form.inviteNumberMoney" placeholder="请输入已提现的邀请人数" />
        </el-form-item>
        <el-form-item label="总金额" prop="inviteMoneyTotal">
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: {
        ...
        inviteNumberNotMoney: undefined,
        inviteNumberMoney: undefined,
      ...
      rules: {
        ...
        inviteNumberTotal: [
          { required: true, message: "总邀请人数不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除用户邀请商编号为"' + userIds + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有用户邀请商数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
