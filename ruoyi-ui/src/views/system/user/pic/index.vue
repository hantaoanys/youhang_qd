<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="picSeq">
        <el-input
          v-model="queryParams.picSeq"
          placeholder="请输入${comment}"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="picList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="discription" />
      <el-table-column label="${comment}" align="center" prop="picSeq" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="discription">
          <el-input v-model="form.discription" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="${comment}" prop="picSeq">
          <el-input v-model="form.picSeq" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="deleteTime">
          <el-date-picker clearable size="small" style="width: 200px"
