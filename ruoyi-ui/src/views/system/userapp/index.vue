<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
     ...
     <!--  <el-form-item label="帐号状态" prop="inviteUser">
        <el-input
     ...
     <!--  <el-form-item label="最后登陆IP" prop="loginIp">
      ...
      <el-form-item label="登录失败计数" prop="errorNumber">
        <el-input
          v-model="queryParams.errorNumber"
          placeholder="请输入登录失败计数"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
     ...
     <!--  <el-table-column label="用户类型" align="center" prop="userType" /> -->
      ...
      <el-table-column label="用户邀请码" align="center" prop="myInviteCode" />
      <!-- <el-table-column label="帐号状态" align="center" prop="inviteCode" />
      <el-table-column label="帐号状态" align="center" prop="inviteUser" /> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="帐号状态" prop="myInviteCode">
          <el-input v-model="form.myInviteCode" placeholder="请输入帐号状态" />
        </el-form-item>
        <el-form-item label="帐号状态" prop="inviteCode">
          <el-input v-model="form.inviteCode" placeholder="请输入帐号状态" />
        </el-form-item>
        <el-form-item label="帐号状态" prop="inviteUser">
          <el-input v-model="form.inviteUser" placeholder="请输入帐号状态" />
        </el-form-item>
        ...
        <el-form-item label="登录失败计数" prop="errorNumber">
          <el-input v-model="form.errorNumber" placeholder="请输入登录失败计数" />
        </el-form-item>
      </el-form>
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, exportUser } from "@/api/system/userapp";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除APP用户信息编号为"' + userIds + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有APP用户信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
